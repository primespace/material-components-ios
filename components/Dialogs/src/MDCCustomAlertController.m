...
@interface MDCCustomAlertController ()
...
@implementation MDCCustomAlertController {
...
+ (instancetype)alertControllerWithTitle:(nullable NSString *)alertTitle
                                 customview:(nullable UIView *)customview {
    MDCCustomAlertController *alertController =
    [[MDCCustomAlertController alloc] initWithTitle:alertTitle customview:customview];
...
- (nonnull instancetype)initWithTitle:(nullable NSString *)title
    ...
    if (self) {
        ...
        _customViewHeight = CGRectGetHeight(customview.frame);
...
//    self.customView.frame = CGRectMake(0, 0, 100, 1000);
...
+ (NSString *)bundlePathWithName:(NSString *)bundleName {
    ...
    NSBundle *bundle = [NSBundle bundleForClass:[MDCCustomAlertController class]];
...
//    CGSize customSize = [self.customView sizeThatFits:boundsSize];
    ...
    if (0.0 < titleSize.height && 0.0 < customSize.height) {
...
//    NSLog(@"%f %f", customSize.width, customSize.height);
//
//    CGFloat contentWidth = MAX(titleSize.width, customSize.width);
...
//        contentInternalVerticalPadding = MDCDialogContentVerticalPadding;
//    }
//    CGFloat contentHeight = titleSize.height + contentInternalVerticalPadding + customSize.height;
